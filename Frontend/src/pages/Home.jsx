    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <nav className="px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="space-x-4">
            <Link to="/signin" className="text-gray-600 text-m   hover:text-gray-900">
              Sign In
            </Link>
            <Link to="/signup" className="text-m text-white w-30 bg-blue-600 rounded-xl p-2">
              Sign Up
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center">
          <h1 className="text-7xl md:text-6xl font-bold text-gray-900 mb-6 animate-fade-in">
            Collab, Create,{" "}
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto animate-fade-in">
            Join a community of innovators, creators, and problem-solvers. Find
            your next project, connect with like-minded individuals, and build
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="card text-center group hover:scale-105 transition-transform duration-200">
            ...
            <p className="text-gray-600">
             Our platform is simple and intuitive, letting you post projects, find collaborators, and manage everything effortlessly—no tech skills needed.
            </p>
          </div>
          ...
          <div className="card text-center group hover:scale-105 transition-transform duration-200">
            ...
            <p className="text-gray-600">
              Access cutting-edge tools, resources, and mentorship to bring your
          ...
          <div className="card text-center group hover:scale-105 transition-transform duration-200">
            ...
            <p className="text-gray-600">
              Earn badges, build streaks, and level up as you collaborate and
              contribute to amazing projects.
            </p>
          </div>
        </div>
      </div>
